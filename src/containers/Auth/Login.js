...
function LogIn(props) {
    ...
    return (
        <React.Fragment>
            <Helmet>
                <title>Burger Builder | Login</title>
                <meta
                    name='description'
                    content='Welcome to the Burger Builder App. Please Login to continue or Login if you are a new user'
                />
            </Helmet>
            ...
            <StyledDiv>
                ...
                {!isLoading && (
                    <h2 style={{ color: '#404040' }}>LOG IN</h2>
                )}
                {!isLoading && (
